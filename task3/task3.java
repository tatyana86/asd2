...
class BST<T>
{
    ...
    public ArrayList<BSTNode> WideAllNodes()
    {
        ...
        Queue<BSTNode> queueOfNodes = new LinkedList<>();

        queueOfNodes.add(Root);

        while(! queueOfNodes.isEmpty()) {
            BSTNode<T> node = queueOfNodes.remove();
            allNodes.add(node);
            if(node.LeftChild != null) {
                queueOfNodes.add(node.LeftChild);
            }
            if(node.RightChild != null) {
                queueOfNodes.add(node.RightChild);
            }
        }
    ...
    public ArrayList<BSTNode> DeepAllNodes(int numberOfOrder)
    {
        if(Root == null) {
            return new ArrayList<>();
        }
        if(numberOfOrder == IN_ORDER) {
            return deepInOrder(Root);
        }
        if(numberOfOrder == POST_ORDER) {
            return deepPostOrder(Root);
        }
        if(numberOfOrder == PRE_ORDER) {
            return deepPreOrder(Root);
        }

        return new ArrayList<>();
    }

    private ArrayList<BSTNode> deepInOrder(BSTNode<T> node)
    {
        ArrayList<BSTNode> allNodes = new ArrayList<>();
    ...
    private ArrayList<BSTNode> deepPostOrder(BSTNode<T> node)
    {
        ArrayList<BSTNode> allNodes = new ArrayList<>();
    ...
    private ArrayList<BSTNode> deepPreOrder(BSTNode<T> node)
    {
        ArrayList<BSTNode> allNodes = new ArrayList<>();
